...
export const upcoming_plan_expiry_template = (
...
<html lang="en">
  <head>
    ...
    <title>Annual Subscription Expiration</title>
        ...
        <td>
          <div class="contour-area">
            ...
            <div class="welcome-text-area">
              <h2>Annual Subscription Expiration</h2>
            </div>
            <div class="padlock-img-div">
              <img
                src="https://syncventory-aws.s3.us-east-2.amazonaws.com/template/email/responsive/sub-expired.png"
              />
            </div>
          </div>
        </td>
        ...
        <td>
          <div class="white-area">
            ...
            <p style="margin-top: 30px; color: #000000">
              Your Subscription is Set to Expire in 7 Days.
            </p>
            <p style="margin-top: 30px; color: #667085">
              We’re reaching out to remind you that your annual subscription to
              Syncventory will expire in 7 days, on ${template.date_time}.
            </p>
            <p style="margin-top: 30px; color: #667085">
              To ensure uninterrupted access to our services, take a moment to
              review your subscription details if needed.
            </p>

            <button style="width: 100%">Manage Subscription</button>
