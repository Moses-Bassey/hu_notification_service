...
export const sign_up_template = (template: EmailProcessor): string => {
  return `<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
        ...
        <td>
          <div class="white-area">
            ...
            <p style="margin-top: 30px; color: #667085">
              Congratulations on taking the first step towards streamlining your
              e-commerce operations.
            </p>

            <p style="margin-top: 30px; color: #667085">
              We are thrilled to welcome you to Syncventory. With Syncventory,
              you can effortlessly synchronize your inventory, track sales,
              manage orders, and gain valuable insights to drive your business
              forward and increase sales.  
            </p>

            <p style="margin-top: 30px; color: #667085">
              As a new user, we will make sure you have a seamless experience
              with our powerful inventory management system.
            </p>
            ...
            <p style="margin: 30px 0; font-weight: 400; color: #8d98af">
              Kindly be aware that the verification link will become invalid
              after 24 hours. If the link expires, you will have to request a
              new one.
            </p>
            <p style="margin: 30px 0; color: #000000">
              For further assistance or if you have any questions, please
              contact our
            </p>
