...
export const account_activation_template = (template: EmailProcessor): string => {
    return `<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
        ...
        <td>
          <div class="white-area">
            ...
            <p style="margin-top: 20px; color: #667085">
              We noticed you haven’t activated your Syncventory account yet, and
              we don’t want you to miss out on everything we have to offer!
            </p>
          </div>
        </td>
      </tr>
            ...
            <div style="background-color: #fbfbfd; padding: 18px">
              <div>
                ...
                <p style="margin-top: 4px; color: #667085">
                  By activating your account, you’ll unlock access to:
                </p>
              </div>
              <div style="margin-top: 30px">
                <h1 style="font-size: 16px; font-weight: 600">
                  1. Inventory Forecasting and Restocking Alerts
                </h1>
                <p style="margin-top: 4px; color: #667085">
