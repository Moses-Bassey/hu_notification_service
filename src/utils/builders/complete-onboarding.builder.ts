...
export const complete_onboarding_template = (template: EmailProcessor): string => {
    return `<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
        ...
        <td>
          <div class="contour-area">
            ...
            <div class="padlock-img-div">
              <img
                src="https://syncventory-aws.s3.us-east-2.amazonaws.com/template/email/responsive/account-activate.png"
              />
            </div>
          </div>
        </td>
        ...
        <td>
          <div class="white-area">
            ...
            <h1 style="font-size: 18px; font-weight: 600">
              Complete Your Onboarding & Unlock Full Access 
            </h1>

            <p style="margin-top: 20px; color: #667085">
              We noticed you haven’t completed your onboarding yet! To get the most out of 
Syncventory, take a few minutes to finish setting up your account.
            </p>
          </div>
        </td>
      </tr>
      <tr>
        <td>
          <div class="white-area">
            <div style="background-color: #fbfbfd; padding: 18px">
              <div>
                <h1 style="font-size: 16px; font-weight: 600">
                  Why To Expect?
                </h1>
                <p style="margin-top: 4px; color: #667085">
                  By completing your onboarding, you’ll unlock access to:
                </p>
              </div>
              <div style="margin-top: 30px">
                <h1 style="font-size: 16px; font-weight: 600">
                  1. Access all features seamlessly
                </h1>
                <p style="margin-top: 4px; color: #667085">
                  Get automated alerts when stock levels fall below predefined
                  thresholds, suggesting optimal restock quantities.
                </p>
              </div>
              <div style="margin-top: 30px">
                <h1 style="font-size: 16px; font-weight: 600">
                  2. Sync your inventory and streamline management
                </h1>
                <p style="margin-top: 4px; color: #667085">
                  Enable users to track inventory levels for each location in
                  real time. Provide tools to transfer stock between locations
                  and optimize stock allocation.
                </p>
              </div>
              <div style="margin-top: 30px">
                <h1 style="font-size: 16px; font-weight: 600">
                  3.  Start making the most of your subscription
                </h1>
                <p style="margin-top: 4px; color: #667085">
                  Provide actionable recommendations for stocking popular items
                  or discontinuing underperforming ones.
                </p>
              </div>
            </div>
      ...
      <tr>
        <td>
          <div class="white-area">
            <button style="width: 100%">Activate My Account</button>
            <p style="margin: 10px 0; font-weight: 400; color: #8d98af">
