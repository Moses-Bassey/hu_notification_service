...
export const payment_failure_template = (template: EmailProcessor): string => {
    return `<!DOCTYPE html>
    <html lang="en">
      <head>
        <meta charset="UTF-8" />
            ...
            <td>
              <div class="contour-area">
                ...
                <div class="padlock-img-div">
                  <img
                    src="https://syncventory-aws.s3.us-east-2.amazonaws.com/template/email/responsive/sub-failed.png"
                  />
                </div>
              </div>
            </td>
            ...
            <td>
              <div class="white-area">
                ...
                <p style="margin-top: 30px; color: #667085">
                  we couldn’t process your recent payment. Update your payment method.
                </p>
