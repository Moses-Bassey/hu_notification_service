...
export const subscription_plan_change_template = (template: EmailProcessor): string => {
    return `<!DOCTYPE html>
    <html lang="en">
      <head>
        <meta charset="UTF-8" />
            ...
            <td>
              <div class="contour-area">
                ...
                <div class="padlock-img-div">
                  <img
                    src="https://syncventory-aws.s3.us-east-2.amazonaws.com/template/email/responsive/sub-upgrade-sm.png"
                  />
                </div>
              </div>
            </td>
            ...
            <td>
              <div class="white-area">
                ...
                <p style="margin-top: 30px; color: #667085">
                  your plan has been successfully ${template.graded_state} to ${template.plan_name}.
                </p>
