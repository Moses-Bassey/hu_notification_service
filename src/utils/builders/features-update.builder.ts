...
export const feature_update_template = (template: EmailProcessor): string => {
    return `<!DOCTYPE html>
    <html lang="en">
      <head>
        <meta charset="UTF-8" />
            ...
            <td>
              <div class="contour-area">
                ...
                <div class="padlock-img-div">
                  <img
                    src="https://syncventory-aws.s3.us-east-2.amazonaws.com/template/email/responsive/feature-updates.png"
                  />
                </div>
              </div>
            </td>
          ...
          <tr>
            <td>
              <div class="white-area">
                <h2>Hello ${template.name},</h2>
    
                <p style="margin-top: 30px; color: #667085">
                  we’re thrilled to introduce new features. Explore them here: ${template.link}.
                </p>
