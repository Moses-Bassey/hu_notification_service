...
export const notification_preference_template = (template: EmailProcessor): string => {
    return `<!DOCTYPE html>
    <html lang="en">
      <head>
        <meta charset="UTF-8" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <title>Notification Preference Updated</title>
            ...
            <td>
              <div class="contour-area">
                ...
                <div class="welcome-text-area">
                  <h2>Notification Preference Updated!  </h2>
                </div>
                <div class="padlock-img-div">
                  <img
                    src="https://syncventory-aws.s3.us-east-2.amazonaws.com/template/email/responsive/notification-settings.png"
                  />
                </div>
              </div>
            </td>
            ...
            <td>
              <div class="white-area">
                ...
                <p style="margin-top: 30px; color: #667085">
                  your notification preferences were successfully updated.
                </p>
