        ...
        <td>
          <div class="contour-area">
            ...
            <div class="padlock-img-div">
              <img
                src="https://syncventory-aws.s3.us-east-2.amazonaws.com/template/email/responsive/email-verification-sm.png"
              />
            </div>
          </div>
        </td>
      ...
      <tr>
        <td>
          <div class="white-area">
            ...
            <p style="margin-top: 30px; color: #667085">
              Kindly login into your Syncventory account and begin the
              onboarding process.
            </p>
            ...
            <p style="margin: 30px 0; font-weight: 400; color: #8d98af">
              If you have any questions or need assistance with anything related
              to our platform, please don't hesitate to reach out to our support
              team.  
            </p>
            <p style="margin: 30px 0; font-weight: 400; color: #8d98af">
              Thank you once again for joining Syncventory. We look forward to
              providing you with a seamless and enjoyable experience. 
            </p>
