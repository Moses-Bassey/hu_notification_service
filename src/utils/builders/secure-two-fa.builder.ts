...
export const secure_two_fa_template = (template: EmailProcessor): string => {
    return `<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Two-Factor Authentication Activation Reminder</title>
        ...
        <td>
          <div class="contour-area">
            ...
            <div class="welcome-text-area">
              <h2>Two-Factor Authentication Activation Reminder</h2>
            </div>
        ...
        <td>
          <div class="white-area">
            ...
            <p style="margin-top: 20px; color: #667085">
              We noticed that you haven’t completed setting up Two-Factor
              Authentication Two-Factor Authentication for your Syncventory
              account. Adding Two-Factor Authentication is an important step to
              keep your account secure and protect your data.
            </p>
          </div>
        </td>
      </tr>
          ...
          <div class="white-area">
            <div style="background-color: #fbfbfd; padding: 18px">
              ...
              <div style="margin-top: 30px">
                ...
                <p style="margin-top: 4px; color: #667085">
                  Prevent unauthorized access even if someone gets hold of your
                  password.
                </p>
              </div>
              <div style="margin-top: 30px">
                ...
                <p style="margin-top: 4px; color: #667085">
                  Setting it up takes only a few moments.
                </p>
              </div>
            </div>
            <p style="margin-top: 10px; color: #667085">
              To enable Two-Factor Authentication , simply follow the link below
              and complete the setup:
            </p>
            <div
              style="background-color: #f0f3f6; padding: 20px; margin-top: 20px"
            >
              <a
                style="text-decoration: none"
                href="https://www.syncventory.co/87345ughbvniu4n5jmrtvg34"
                >https://www.syncventory.co/87345ughbvniu4n5jmrtvg34</a
              >
            </div>
            <p style="margin-top: 10px; color: #667085">
