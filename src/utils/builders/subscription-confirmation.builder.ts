...
export const subscription_confirmation_template = (template: EmailProcessor): string => {
    return `<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
          ...
          <div class="contour-area">
            ...
            <div class="welcome-text-area">
              ...
              <p style="margin-top: 10px; color: #667085">
                Your Subscription was confirmed successfully.  
              </p>
            </div>
            <div class="padlock-img-div">
              <img
                src="https://syncventory-aws.s3.us-east-2.amazonaws.com/template/email/responsive/sub-success.png"
              />
            </div>
          </div>
        </td>
        ...
        <td>
          <div class="white-area">
            ...
            <p style="margin-top: 30px; color: #667085">
              You now have access to a wide range of enhanced features and
              functionalities that will boost your experience and help you
              achieve your goals more efficiently. 
            </p>

            <p style="margin-top: 30px; color: #667085">
            Your plan details: <strong>Plan Name: </strong>${template.plan_name}, <strong>Start Date: </strong>${template.start_date}, <strong> Renewal Date: </strong>${template.renewal_date}.
            </p>
