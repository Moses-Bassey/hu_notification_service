            ...
            <td>
              <div class="contour-area">
                ...
                <div class="padlock-img-div">
                  <img
                    src="https://syncventory-aws.s3.us-east-2.amazonaws.com/template/email/responsive/system-maintain-notif.png"
                  />
                </div>
              </div>
            </td>
            ...
            <td>
              <div class="white-area">
                ...
                <p style="margin-top: 30px; color: #667085">
                  Dear User, we’ll be performing system maintenance on ${template.date_time}. Thank you for your understanding.
                </p>
